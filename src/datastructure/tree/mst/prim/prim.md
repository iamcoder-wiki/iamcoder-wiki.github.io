...
프림의 알고리즘은 가중치가 작은 간선부터 트리에 추가해 가며 최소 스패닝 트리를 구한다는 면에서는 [크루스칼의 알고리즘](../kruskal/kruskal.md)과 같습니다.
[크루스칼의 알고리즘](../kruskal/kruskal.md)은 간선들이 서로 연결되어 있지 않더라도 가중치가 작으면 트리에 추가하는 반면, 프림의 알고리즘에서는 현재 최소 스패팅 트리에 연결된 간선만 트리에 추가한다는 것이 프림 알고리즘과 [크루스칼의 알고리즘](../kruskal/kruskal.md)의 차이점입니다.

## 과정

다음 그래프에 프림 알고리즘을 적용하여 MST를 구해보자.

<img src="./prim1.png" width = 500 >

<img src="./prim2.svg" width = 500 >
